...
need "$CAP/docs/PLAIN_EXPLAIN.md" "capture profile ships plain explain"
...
need "$LIVE/docs/PLAIN_EXPLAIN.md" "baseline ships plain explain"
...
need "$LIVE/docs/workflow-lab/CURSOR_CHAT_HYGIENE.md" "lab ships CURSOR_CHAT_HYGIENE"
need "$LIVE/docs/workflow-lab/CLOSE_CHAT.md" "lab ships CLOSE_CHAT"
need "$LIVE/docs/workflow-lab/PLAIN_EXPLAIN.md" "lab ships PLAIN_EXPLAIN"
need "$LIVE/docs/workflow-lab/AGENTIC_INTERACTION.md" "lab ships AGENTIC_INTERACTION"
