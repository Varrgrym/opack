# Pasteable prompts (workflow lab)
...
| **Close out this chat** (goals check · extract · YES/NO close) | `CLOSE_CHAT.md` |
...
Roles endure; tissue is a snapshot — seats docs.
