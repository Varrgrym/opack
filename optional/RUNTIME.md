...
| **Close-out phrase** — operator says “close out this chat” / “can I close?” | Run `CLOSE_CHAT.md` once → YES / NO / YES WITH LAND. Park optional non-blocking follow-ups to a durable `@`-able note (not chat-only). Do not start new work unless they say land/fix. |
