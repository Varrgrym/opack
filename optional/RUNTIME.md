...
| **Close-out phrase** — “close out this chat” / “can I close?” | `CLOSE_CHAT.md` read → honest state (goal vs workaround) → **go** land + close. Product NOT DONE ≠ auto-NO. No day #10 auto. **fix** only if blocking today. |
